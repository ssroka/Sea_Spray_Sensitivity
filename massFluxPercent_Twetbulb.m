...
%             TH_src = sprintf('/Users/ssroka/Documents/MATLAB/mpm/sandbox/results/res_fm_Eng/SST_27_28_29/SST_%d',SST_C);
                    ...
                    for U10_ind = nU10:-1:1
                        ...
                        for r0_ind = 1:nr0
                            ...
                            if (tof_ind == 1) && (RH_ind == 1) && (DT_ind == 1) && (SST_ind == 1)
                                tof_mat(r0_ind,U10_ind) = compute_tauf(U10,SST_C,r0_m,m_s,s0,p0,T_a,maxEr_uf,maxIt); % meters
    ...
    save(sprintf('ratios_%s',SSGF_str),'RT','RbT','Ru','Rbu','Rr','Rbr',...
        'frac_tauf_T','frac_taub_T','frac_tauf_u','frac_taub_u','frac_tauf_r','frac_taub_r',...       
        'r0_vec','U10_vec','RH_vec','DT_vec','SST_vec','tof_vec',...
        'dFdr_vec_mat','tof_mat','t_b_mat');
end
