...
\begin{figure}[h!]
   ...
   \hspace*{-0.5in} \begin{subfigure}[t!]{0.49\textwidth}
        \includegraphics[width=1.1\textwidth]{imgs/together_DT.png} 
            \caption{\label{dDT}}       
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[t!]{0.49\textwidth}
        \includegraphics[width=1.1\textwidth]{imgs/together_RH.png}   
                    \caption{\label{dRH}}            
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
    %(or a blank line to force the subfigure onto a new line)
        \begin{subfigure}[t!]{0.7\textwidth}
        \includegraphics[width=\textwidth]{imgs/together_r0.png}
                    \caption{\label{dr0}}               
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
...
\begin{figure}[h!]
    ...
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[t!]{0.2\textwidth}
        \hspace*{-4.5in}\vspace*{-1.7in}\includegraphics[width=.9\textwidth]{imgs/changeRH_Legend.png}        
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
    %(or a blank line to force the subfigure onto a new line)
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t!]{0.23\textwidth}
        \hspace*{-4in}\vspace*{2in}\includegraphics[width=.9\textwidth]{imgs/changeDTLegend.png}        
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
    %(or a blank line to force the subfigure onto a new line)
